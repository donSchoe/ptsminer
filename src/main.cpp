...
//                  SetThreadPriority(THREAD_PRIORITY_LOWEST);
            ...
            pblock->nTime = max(pindexPrev->GetMedianTimePast()+1, (int64)block_provider->GetAdjustedTimeWithOffset(thread_id));
